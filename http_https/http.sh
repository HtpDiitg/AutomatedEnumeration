...
gobuster dir -u http://$ip/ -w /usr/share/seclists/Discovery/Web-Content/raft-medium-directories-lowercase.txt –f


echo -e "\n\n${BWhite}Web Crawling using gospider:${NC}"
gospider -d 3 --robots --sitemap -t 5 -s http://$ip:$port/
...
python crawleet/crawleet.py -u http://$ip:$port/ -b -d 3 -e jpg,png,css -f -m -s -x html,php,txt -y --threads 10
